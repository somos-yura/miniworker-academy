export const systemMessages = [
	...
	{
		message: 'Necesitamos una plataforma que permita a organizaciones sin fines de lucro gestionar sus donaciones. Debe incluir registro de donantes, seguimiento de aportes y generación de reportes mensuales. ¿Puedes presentar una propuesta técnica?',
		name: 'María González',
		role: 'Stakeholder - Simulado por IA',
	},
	{
	...
	{
		message: 'El sistema debe ser accesible para personas con discapacidad visual. Necesitamos que cumpla con los estándares WCAG 2.1 nivel AA. Además, debe funcionar correctamente en dispositivos móviles.',
		name: 'Carlos Ramírez',
		role: 'Stakeholder - Simulado por IA',
	},
	{
